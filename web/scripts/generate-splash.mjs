...
if (!existsSync(FONT_PATH)) {
  console.error('Falta IBM Plex Mono 400 em web/scripts/_plex-mono-400.ttf. Roda:');
  console.error('  curl -sL "https://fonts.gstatic.com/s/ibmplexmono/v20/-F63fjptAgt5VM-kVkqdyU8n5ig.ttf" -o web/scripts/_plex-mono-400.ttf');
  process.exit(1);
}
...
console.log(`\nGerados ${DEVICES.length * 2} splashes em web/public/assets/splash/`);
