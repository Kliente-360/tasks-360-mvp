...
function app() {
  ...
  const base = {
    ...
    _autosaveTimer: null,
    _autosaveSeq: 0,
    // Tick reativo (incrementa a cada 5s enquanto modal aberto) pra autosaveLabel atualizar sem input.
    // SEM underscore: garante que Alpine trackeia mutações via Proxy (alguns plugins/builds
    // ignoram props _-prefixadas como "internas").
    autosaveTick: 0,
