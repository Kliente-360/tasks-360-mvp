  ...
  function makeAdoptionView() {
    return {
      ...
      get adoptionSuccessIndicators() {
        ...
        // Conclusão heurística: avalia o conjunto.
        ...
        if (verdes === 4) {
          conclusao = 'Todos os indicadores verdes. Adoção interna saudável — pronto pra avançar pra piloto externo controlado.';
          conclusaoSeveridade = 'verde';
        } else if (verdes >= 3 && vermelhos === 0) {
          const fraca = cards.find(c => c.sig === 'amarelo');
          conclusao = `${verdes} de 4 indicadores verdes. Foco em "${fraca.label}" pra fechar o gap — meta ${fraca.metaText.replace('meta 30d ', '')}.`;
          conclusaoSeveridade = 'amarelo';
        } else if (vermelhos === 0) {
          conclusao = 'Indicadores em amarelo. Adoção crescendo mas ainda inconsistente — reforçar hábito diário antes de mais features.';
          conclusaoSeveridade = 'amarelo';
        } else {
