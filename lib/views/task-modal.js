  ...
  function makeTaskModalView() {
    return {
      ...
      openEdit(t) {
        ...
        // Ticker reativo pro autosaveLabel atualizar "salvo · agora" → "salvo · há 30s" sem precisar de input.
        if (this._autosaveTimer) clearInterval(this._autosaveTimer);
        this._autosaveTimer = setInterval(() => { this._autosaveTick = (this._autosaveTick || 0) + 1; }, 5000);
        this.editingCommentId = '';
        this.editingCommentDraft = '';
        this.newDepId = '';
        this.editingComments = [];
      ...
      autosaveLabel() {
        // Touch _autosaveTick pra Alpine re-rodar este getter quando o ticker bate.
