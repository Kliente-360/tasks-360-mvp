    ...
    return {
      ...
      async saveTask(opts) {
        ...
        if (e.id) {
          ...
          if (error) {
            if (prev) this.tasks = this.tasks.map((t, idx) => idx === i ? prev : t);
          ...
          // Bumpa _dataRev pra invalidar memos (triagem, heurísticas, etc.)
          // que dependem de campos sem timestamp (prazo, pessoaId, esforço, etc.).
