...
(function () {
  ...
  const TIER = Object.freeze({ ESTRATEGICO: 'estrategico', RECORRENTE: 'recorrente', SPOT: 'spot' });
  ...
  Object.assign(window, {
    APP_VERSION,
    STATUS, ROLE, TIER, PRIORIDADE, SEVERIDADE, SIGNAL, CARGA_NIVEL,
