...
(function () {
  ...
  //   MAJOR (1 dígito):  era arquitetural. 1 = protótipo modular (era single-file).
  ...
  //   BUILD (3 dígitos): **número do último PR mergeado em main**. Espelho 1:1.
  //                      Bumpa em TODO PR (docs, teste, refactor, feat).
  //                      Fácil rastrear "que versão está em produção?" → cruza
  //                      direto com github.com/.../pull/<n>.
  //
  // BUMPAR manualmente neste arquivo no commit que vira o PR. Pegar o próximo
  // número da fila de PRs (o que ainda não existe). Se errar e o PR pegar
  // outro número, a próxima sessão corrige em PR de docs.
  //
  // Quebra grande de UX/dados ainda usa MINOR += 1, BUILD = PR number.
  // Saída do single-file/modular pro Next: MAJOR = 2, MINOR = 00, BUILD = PR.
  const APP_VERSION = 'v1.01.218';
