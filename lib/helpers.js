...
(function () {
  ...
  //          UX/dados (nova aba, novo modelo).
  //   BUILD: incrementa +1 a cada commit em main (push direto, sem PRs).
  //          Continua a sequência herdada do esquema antigo de PR-number
  //          (último PR mergeado foi #221).
  const APP_VERSION = 'v1.01.233';
